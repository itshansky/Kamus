...
public class Fragment_id_eng extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getResources().getString(R.string.app_name)+"/"+getResources().getString(R.string.indo_inggris));
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_id_eng, container, false);
